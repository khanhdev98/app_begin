...
/// Chỉnh sửa dựa trên [CheckBox] theo thiết kế Material 3,
/// sẽ xoá khi Flutter cập nhật Checkbox mới theo Material 3
...
class HaloCheckbox extends StatefulWidget {
  ...
  /// of the [HaloCheckbox], providing a different [Color] when it is
  /// [MaterialState.disabled].
  ///
  /// ```dart
  /// Checkbox(
  ...
  @override
  State<HaloCheckbox> createState() => _HaloCheckboxState();
}

class _HaloCheckboxState extends State<HaloCheckbox> with TickerProviderStateMixin, ToggleableStateMixin {
  ...
  @override
  void didUpdateWidget(HaloCheckbox oldWidget) {
...
const double _kEdgeSize = HaloCheckbox.width;
const double _kStrokeWidth = 1.2;
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  void _drawCheck(Canvas canvas, Offset origin, double t, Paint paint) {
    ...
    const Offset start = Offset(_kEdgeSize * 0.22, _kEdgeSize * 0.45);
    const Offset mid = Offset(_kEdgeSize * 0.42, _kEdgeSize * 0.65);
    const Offset end = Offset(_kEdgeSize * 0.78, _kEdgeSize * 0.28);
    if (t < 0.5) {
