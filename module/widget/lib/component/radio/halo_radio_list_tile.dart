...
///
/// To show the [HaloRadioListTile] as disabled, pass null as the [onChanged]
/// callback.
///
/// {@tool dartpad}
...
class HaloRadioListTile<T> extends StatelessWidget {
  ...
  /// If specified, [shape] defines the shape of the [HaloRadioListTile]'s [InkWell] border.
  final ShapeBorder? shape;

  /// If specified, defines the background color for `RadioListTile` when
  /// [HaloRadioListTile.selected] is false.
  final Color? tileColor;

  /// If non-null, defines the background color when [HaloRadioListTile.selected] is true.
  ...
  Widget build(BuildContext context) {
    final Widget control = HaloRadio<T>(
      value: value,
