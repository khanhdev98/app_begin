...
/// be selected. The values are of type `T`, the type parameter of the [HaloRadio]
...
class HaloRadio<T> extends StatefulWidget {
  ...
  const HaloRadio({
    ...
    this.autofocus = false,
        ...
        assert(toggleable != null), super(key: key);
  ...
  /// of the [HaloRadio], providing a different [Color] when it is
  /// [MaterialState.disabled].
  ///
  /// ```dart
  /// Radio<int>(
  ...
  @override
  State<HaloRadio<T>> createState() => _HaloRadioState<T>();
}

class _HaloRadioState<T> extends State<HaloRadio<T>> with TickerProviderStateMixin, ToggleableStateMixin {
  ...
  @override
  void didUpdateWidget(HaloRadio<T> oldWidget) {
