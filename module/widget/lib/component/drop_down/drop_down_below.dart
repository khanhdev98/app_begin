...
///https://github.com/whatamelon/flutter_dropdown_below/blob/master/lib/dropdown_below.dart
        ...
        child: InkWell(
          child: Container(
            decoration: widget.isDivider
                ? BoxDecoration(
                    border: Border(
                        bottom: itemIndex + 1 != route.items?.length
                            ? BorderSide(color: context.outlineColor.withOpacity(0.4), width: 0.5)
                            : BorderSide.none))
                : const BoxDecoration(),
...
class DropdownBelow<T> extends StatefulWidget {
  ...
  /// nghe su kien click vao dropdown button
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: GestureDetector(
          onTap: widget.items.isEmpty ? null : _handleTap,
