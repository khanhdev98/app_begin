...
class _LanguageSelectState extends State<LanguageSelect> {
              ...
              children: [
                TextButton(
                  ...
                  onPressed: () => onPressed(context, provider, L10n.I.en.languageCode,
                      provider.languageCodeLocale == (L10n.I.en.languageCode)),
                ),
              ],
            ),
          ),
              ...
              children: [
                TextButton(
                  ...
                  onPressed: () => onPressed(context, provider, L10n.I.vi.languageCode,
                      provider.languageCodeLocale == L10n.I.vi.languageCode),
                ),
              ],
            ),
          ),
  ...
  onPressed(BuildContext context, LocaleProvider provider, String languageCode, bool isActivated) {
    print('khanhtran ');
    //fake loading ....
    if (isActivated) {
      return;
