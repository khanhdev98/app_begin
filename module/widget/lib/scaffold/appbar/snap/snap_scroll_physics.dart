...
class CupertinoAppBarSnapScrollPhysics extends BaseSnapScrollPhysics {
  CupertinoAppBarSnapScrollPhysics({ScrollPhysics? parent}) : super(parent: parent);
  @override
  final List<Snap> snaps = [Snap.avoidZone(0, _kNavBarLargeTitleHeightExtension)];
...
class BuilderSnapScrollPhysics extends BaseSnapScrollPhysics {
  const BuilderSnapScrollPhysics(this.builder, {ScrollPhysics? parent}) : super(parent: parent);
...
abstract class BaseSnapScrollPhysics extends ScrollPhysics implements SnapScrollPhysics {
  ...
  double _getTargetPixels(
      ScrollMetrics position, double proposedEnd, Tolerance tolerance, double velocity) {
  ...
  Simulation? createBallisticSimulation(ScrollMetrics position, double velocity) {
    ...
    final double target = _getTargetPixels(position, proposedPixels, tolerance, velocity);
  ...
  Snap? getSnap(ScrollMetrics position, double proposedEnd, Tolerance tolerance, double velocity) {
